...
WSADATA			RS_WSAData;  
SOCKET			RS_SSocket;
char			RS_Hostname[128];
HOSTENT*		RS_Hostinfo;
SOCKADDR_IN		RS_SocketAddress;
static u_long   RS_Flag = 1;
NetStat			RS_NetStat;
...
int main() {
	...
	int main() {
		...
		xmlFile.close();
		std::cout << "XML-файл успешно создан!" << std::endl;
